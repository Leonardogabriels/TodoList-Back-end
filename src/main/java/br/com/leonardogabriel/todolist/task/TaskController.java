package br.com.leonardogabriel.todolist.task;
...
import br.com.leonardogabriel.todolist.utils.Utils;
    ...
    public ResponseEntity created(@RequestBody TaskModel taskModel, HttpServletRequest request){
        ...
        if(currentDate.isAfter(taskModel.getStarAt()) || currentDate.isAfter(taskModel.getEndAt())){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                    .body("A data de inicio / data termino deve ser maisor do que a data atual");
        }
